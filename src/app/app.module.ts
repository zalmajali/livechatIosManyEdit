...
@NgModule({
  ...
  providers: [{ provide: RouteReuseStrategy, useClass: IonicRouteStrategy },Globalization,Camera,AppVersion,FirebaseMessaging,Network,Chooser,Device,FileTransfer,FilePath,AndroidPermissions,StatusBar,SQLite,File],
